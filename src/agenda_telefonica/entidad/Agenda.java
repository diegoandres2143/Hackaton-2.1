...
public class Agenda {
    ...
    public boolean agregarContacto(Contacto contacto) {
        ...
        if (agendaLlena()) {
            System.out.println("Error: La agenda está llena. No se puede agregar más contactos.");
            return false;
        }
    ...
    public boolean eliminarContacto(Contacto contacto) {
        ...
        if (contactos.remove(contacto)) {
            ...
            System.out.println("Error: No se encontró el contacto " + contacto.getNombre() + " " + contacto.getApellido() + " en la agenda");
            return false;
        }
    }
     ...
     * @return true si la modificación fue exitosa, false si el contacto no existe
     */
    public boolean modificarTelefono(String nombre, String apellido, String nuevoTelefono) {
        ...
        for (Contacto contacto : contactos) {
            if (contacto.getNombre().equalsIgnoreCase(nombre.trim()) &&
                ...
                try {
                    ...
                    System.out.println("Teléfono modificado exitosamente para " + nombre + " " + apellido +
                            ". Nuevo teléfono: " + nuevoTelefono);
                    return true;
        ...
        System.out.println("Error: No se encontró el contacto " + nombre + " " + apellido + " en la agenda");
        return false;
    }
    ...
    /**
     * Muestra información sobre el estado de la agenda
     */
    public void mostrarInformacion() {
        System.out.println("\n=== INFORMACIÓN DE LA AGENDA ===");
        System.out.println("Tamaño máximo: " + tamanoMaximo);
        System.out.println("Contactos actuales: " + contactos.size());
        System.out.println("Espacios libres: " + espacioLibres());
        System.out.println("¿Agenda llena?: " + (agendaLlena() ? "Sí" : "No"));
    }
